                                    ...
                                    <div className="form-row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label>نام </label>
                                                <input type="text" name="firstName" id="firstName" className="form-control" placeholder="نام" defaultValue="کیوان" />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label>نام خانوادگی</label>
                                                <input type="text" className="form-control" placeholder="نام خانوادگی" defaultValue="علی محمدی" name="lastName" id="lastName" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label>ایمیل</label>
                                        <input type="email" className="form-control" placeholder="آدرس ایمیل خود را وارد کنید" name="email" id="email" defaultValue="keivan.amohamadi@gmail.com" />
                                    </div>
                                    <div className="form-group">
